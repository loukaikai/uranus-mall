package com.uranus.uranusmall.constant;
...
public class MDA {
     ...
     */
    public static final String CLIENT_ID = "tulingmall-member";
     ...
     * 认证服务器登陆地址
     */
    public static final String OAUTH_LOGIN_URL = "http://tulingmall-auth/oauth/token";
